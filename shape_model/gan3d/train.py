...
from architectures import generator_network, Discriminator
from utils import make_ones, make_zeros, load_data, create_train_folders
...
class shape_GAN():
    def __init__(self, cfg, device):
        ...
        self.folder = self.cfg["checkpoints_path"]
        self.zid_dict = self.cfg["zid_dict"]
    ...
    def train(self):
        ...
        self.load_train_dataloader(self.cfg["reduced_data"])
