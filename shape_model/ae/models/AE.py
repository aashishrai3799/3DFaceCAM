...
from architectures import Encoder_identity, Encoder_expression, Decoder
from datasets import CostumDataset
...
class AE(object):
    ...
    def train(self, epoch):
        path_enc_id = './ae/checkpoints/Enc1/'
        path_enc_exp = './ae/checkpoints/Enc2/'
        path_dec = './ae/checkpoints/Dec/'
        ...
        if epoch%2==0:
            torch.save(self.model.encoder1.state_dict(), './ae/checkpoints/Enc1/' + str(int(epoch) ))
            torch.save(self.model.encoder2.state_dict(), './ae/checkpoints/Enc2/' + str(int(epoch) ))
            torch.save(self.model.decoder.state_dict(), './ae/checkpoints/Dec/' + str(int(epoch)))
