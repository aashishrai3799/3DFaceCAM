...
encoder_id.load_state_dict(torch.load("./ae/checkpoints/Enc1/2000", map_location="cpu"))
encoder_ex.load_state_dict(torch.load("./ae/checkpoints/Enc2/2000", map_location="cpu"))
decoder.load_state_dict(torch.load("./ae/checkpoints/Dec/2000", map_location="cpu"))
